...
Options:
  ...
  --block-domain <dom>   Block domain (supports wildcards: *.facebook.com)
    ...
    --ml-model <file>      Load ML traffic classification model file
...
Examples:
    ...
    )" << program << R"( capture.pcap filtered.pcap --ml-model models/traffic_dt_model.txt
